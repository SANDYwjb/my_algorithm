 ...
 * 「当前节点的随机指针指向的节点」可能还没创建，因此我们需要变换思路。一个可行方案是，我们利用回溯的方式，让每个节点的拷贝操作相互独立。
 * 对于当前节点，我们首先要进行拷贝，然后我们进行「当前节点的后继节点」和「当前节点的随机指针指向的节点」拷贝，拷贝完成后将创建的新节点的指针返回，
 * 即可完成当前节点的两指针的赋值。
...
public class CopyRandomList_138 {
    ...
    public Node copyRandomList(Node head) {
        ...
        // head是旧结点，headNew是新的结点，也就是拷贝的结点
